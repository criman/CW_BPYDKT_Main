...
#define    C_TEMP_TEMPSETMAX        	30         //设定温度最大值
#define    C_TEMP_TEMPSETMIN        	7         //设定温度最大值
...
typedef enum
{
	ENUM_CONSERVATIVE_ZONE_INIT,    //初始值-不确定状态
	ENUM_CONSERVATIVE_ZONE_1,       //温度区间1: T1≥33℃
	ENUM_CONSERVATIVE_ZONE_2,       //温度区间2: 27℃≤T1＜33℃
