...
//---------------------------------------------------------------------------------------------------//
#define		Pin_EEPwren							PortPin_Read(GPIOA, GPIO_Pin_31)//SWITCH1 IO端口选择			例子:P00/P0_0										
#define		P_EEPwren_Hi()						DEFINE_PA31_HI					//例子:DEFINE_P00_HI
#define		P_EEPwren_Low()						DEFINE_PA31_LOW					//例子:DEFINE_P00_LOW
#define		P_EEPwren_Output()					DEFINE_PA31_OUTPUT				//例子:DEFINE_P00_OUTPUT
#define		P_EEPwren_Input()					DEFINE_PA31_INPUT				//例子:DEFINE_P00_INPUT
#define		P_EEPwren_Enpull()					DEFINE_PA31_ENPULLUP			//例子:DEFINE_P00_ENPULL
#define		P_EEPwren_Dispull()					DEFINE_PA31_DISPULLUP			//例子:DEFINE_P00_DISPULL
//---------------------------------------------------------------------------------------------------//
...
#define    C_REMEMBER_MODEFUNC_SPEEDMODE            ENUM_FANMODE_HIGH          //03.风速-自动风
#define    C_REMEMBER_MODEFUNC_TEMPCSET_DFT         25	   					   //04.温度设定值(℃) - 25℃
#define    C_REMEMBER_MODEFUNC_COLDCSET_DFT         25	   					   //05.制冷温度设定值(℃) - 25℃
#define    C_REMEMBER_MODEFUNC_HEATCSET_DFT		    27						   //06.制热温度设定值(℃) - 27℃
#define    C_REMEMBER_MODEFUNC_TEMPFSET_DFT         77	   					   //07.温度设定值(℉) - 77℉
#define    C_REMEMBER_MODEFUNC_COLDFSET_DFT         77	   					   //08.制冷温度设定值(℉) - 77℉
