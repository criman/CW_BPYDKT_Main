...
//---------------------------------------------------------------------------------------------------//
#define		Pin_UVC								PortPin_Read(GPIOA, GPIO_Pin_25)//SWITCH1 IO端口选择			例子:P00/P0_0										
#define		P_UVC_Hi()							DEFINE_PA25_HI					//例子:DEFINE_P00_HI
#define		P_UVC_Low()							DEFINE_PA25_LOW					//例子:DEFINE_P00_LOW
#define		P_UVC_Output()						DEFINE_PA25_OUTPUT				//例子:DEFINE_P00_OUTPUT
#define		P_UVC_Input()						DEFINE_PA25_INPUT				//例子:DEFINE_P00_INPUT
#define		P_UVC_Enpull()						DEFINE_PA25_ENPULLUP			//例子:DEFINE_P00_ENPULL
#define		P_UVC_Dispull()						DEFINE_PA25_DISPULLUP			//例子:DEFINE_P00_DISPULL
//---------------------------------------------------------------------------------------------------//
#if (UVC_SigValid == 1)
