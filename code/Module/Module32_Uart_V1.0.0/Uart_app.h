...
//UART0
//---------------------------------------------------------------------------------------------------//
#define		C_UART0_TX_HEAD_FIRST			C_COMMDISP_TX_BYTE1        //发送头码1
#define		C_UART0_TX_HEAD_SECOND			C_COMMDISP_TX_BYTE2        //发送头码2
//---------------------------------------------------------------------------------------------------//
#define		C_UART0_RX_HEAD_FIRST			C_COMMDISP_RX_BYTE1        //接收头码1
#define		C_UART0_RX_HEAD_SECOND			C_COMMDISP_RX_BYTE2        //接收头码2
//---------------------------------------------------------------------------------------------------//
enum
{
    ...
    UART0_RX_CHKSUM = 15,                               //校验
    UART0_RX_LEN    = 16,		                        //UART0接收字节长度
};
//---------------------------------------------------------------------------------------------------//
enum
{
    ...
    UART0_TX_CHKSUM = 27,                               //校验  
    UART0_TX_LEN    = 28,		                        //UART0发送字节长度
};
...
//UART2
//---------------------------------------------------------------------------------------------------//
#define		C_UART2_TX_HEAD_FIRST			0xDD        //发送头码1
#define		C_UART2_TX_HEAD_SECOND			0x01        //发送头码2
//---------------------------------------------------------------------------------------------------//
#define		C_UART2_RX_HEAD_FIRST			0xDD        //接收头码1
#define		C_UART2_RX_HEAD_SECOND			0x00        //接收头码2
//---------------------------------------------------------------------------------------------------//
enum
{
    ...
    UART2_RX_LEN    = 34,//255,		                    //UART2接收字节长度
};
//---------------------------------------------------------------------------------------------------//
enum
{
...
//UART4
//---------------------------------------------------------------------------------------------------//
#define		C_UART4_TX_HEAD_FIRST			0xA5        				//发送头码1
//#define		C_UART4_TX_HEAD_SECOND			0xFF				    //发送头码2
//---------------------------------------------------------------------------------------------------//
#define		C_UART4_RX_HEAD_FIRST			0xA5        				//接收头码1
//#define		C_UART4_RX_HEAD_SECOND			0xFF        			//接收头码2
//---------------------------------------------------------------------------------------------------//
enum
{
...
//    UART4_RX_HEAD_SECOND,	                            //头码2
    ...
    UART4_RX_CHKSUML = 18,                              //校验-低位 
    UART4_RX_CHKSUMH = 19,								//校验-高位 
	UART4_RX_LEN     = 20,		                        //UART4接收字节长度
};
//---------------------------------------------------------------------------------------------------//
enum
{
...
//    UART4_TX_HEAD_SECOND,		                        //头码2
    ...
    UART4_TX_CHKSUML = 18,                              //校验-低位 
	UART4_TX_CHKSUMH = 19,								//校验-高位 
    UART4_TX_LEN     = 20,		                        //UART4发送字节长度
};
//===================================================================================================//
//---------------------------------------------------------------------------------------------------//
//UART5
