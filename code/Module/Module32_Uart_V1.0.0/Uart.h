...
//---------------------------------------------------------------------------------------------------//
#define    P_Uart1_Rx_Hi()                    DEFINE_PA18_HI
#define    P_Uart1_Rx_Low()                   DEFINE_PA18_LOW
#define    P_Uart1_Rx_Output()                DEFINE_PA18_OUTPUT
#define    P_Uart1_Rx_Input()                 DEFINE_PA18_INPUT
#define    P_Uart1_Rx_Enpull()                DEFINE_PA18_ENPULLUP
#define    P_Uart1_Rx_Dispull()               DEFINE_PA18_DISPULLUP
//---------------------------------------------------------------------------------------------------//
#define    P_Uart1_Tx_Hi()                    DEFINE_PA17_HI
#define    P_Uart1_Tx_Low()                   DEFINE_PA17_LOW
#define    P_Uart1_Tx_Output()                DEFINE_PA17_OUTPUT
#define    P_Uart1_Tx_Input()                 DEFINE_PA17_INPUT
#define    P_Uart1_Tx_Enpull()                DEFINE_PA17_ENPULLUP
#define    P_Uart1_Tx_Dispull()               DEFINE_PA17_DISPULLUP
//===================================================================================================//
//选择UART2控制端口
//---------------------------------------------------------------------------------------------------//
//#define    UART2_ENABLE                       //选择打开定义,否不使用则请屏蔽
//---------------------------------------------------------------------------------------------------//
#define    P_Uart2_Rx_Hi()                    DEFINE_PB8_HI
#define    P_Uart2_Rx_Low()                   DEFINE_PB8_LOW
#define    P_Uart2_Rx_Output()                DEFINE_PB8_OUTPUT
#define    P_Uart2_Rx_Input()                 DEFINE_PB8_INPUT
#define    P_Uart2_Rx_Enpull()                DEFINE_PB8_ENPULLUP
#define    P_Uart2_Rx_Dispull()               DEFINE_PB8_DISPULLUP
//---------------------------------------------------------------------------------------------------//
#define    P_Uart2_Tx_Hi()                    DEFINE_PB7_HI
#define    P_Uart2_Tx_Low()                   DEFINE_PB7_LOW
#define    P_Uart2_Tx_Output()                DEFINE_PB7_OUTPUT
#define    P_Uart2_Tx_Input()                 DEFINE_PB7_INPUT
#define    P_Uart2_Tx_Enpull()                DEFINE_PB7_ENPULLUP
#define    P_Uart2_Tx_Dispull()               DEFINE_PB7_DISPULLUP
//===================================================================================================//
//选择UART3控制端口
//---------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------//
#define    P_Uart3_Rx_Hi()                    DEFINE_PA4_HI
#define    P_Uart3_Rx_Low()                   DEFINE_PA4_LOW
#define    P_Uart3_Rx_Output()                DEFINE_PA4_OUTPUT
#define    P_Uart3_Rx_Input()                 DEFINE_PA4_INPUT
#define    P_Uart3_Rx_Enpull()                DEFINE_PA4_ENPULLUP
#define    P_Uart3_Rx_Dispull()               DEFINE_PA4_DISPULLUP
//---------------------------------------------------------------------------------------------------//
#define    P_Uart3_Tx_Hi()                    DEFINE_PA5_HI
#define    P_Uart3_Tx_Low()                   DEFINE_PA5_LOW
#define    P_Uart3_Tx_Output()                DEFINE_PA5_OUTPUT
#define    P_Uart3_Tx_Input()                 DEFINE_PA5_INPUT
#define    P_Uart3_Tx_Enpull()                DEFINE_PA5_ENPULLUP
#define    P_Uart3_Tx_Dispull()               DEFINE_PA5_DISPULLUP
//===================================================================================================//
//===================================================================================================//
//选择UART4控制端口
//---------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------//
#define    P_Uart4_Rx_Hi()                    DEFINE_PB10_HI
#define    P_Uart4_Rx_Low()                   DEFINE_PB10_LOW
#define    P_Uart4_Rx_Output()                DEFINE_PB10_OUTPUT
#define    P_Uart4_Rx_Input()                 DEFINE_PB10_INPUT
#define    P_Uart4_Rx_Enpull()                DEFINE_PB10_ENPULLUP
#define    P_Uart4_Rx_Dispull()               DEFINE_PB10_DISPULLUP
//---------------------------------------------------------------------------------------------------//
#define    P_Uart4_Tx_Hi()                    DEFINE_PB11_HI
#define    P_Uart4_Tx_Low()                   DEFINE_PB11_LOW
#define    P_Uart4_Tx_Output()                DEFINE_PB11_OUTPUT
#define    P_Uart4_Tx_Input()                 DEFINE_PB11_INPUT
#define    P_Uart4_Tx_Enpull()                DEFINE_PB11_ENPULLUP
#define    P_Uart4_Tx_Dispull()               DEFINE_PB11_DISPULLUP
//===================================================================================================//
//选择UART5控制端口
//---------------------------------------------------------------------------------------------------//
...
extern unsigned char g_tx_OutDoorStatus1;
extern unsigned char g_tx_OutDoorStatus2;
extern unsigned char g_tx_OutDoorStatus3;
