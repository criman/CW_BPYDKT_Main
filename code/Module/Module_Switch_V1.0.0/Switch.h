...
#define		Pin_switch2							PortPin_Read(GPIOB, GPIO_Pin_3)//SWITCH2 IO端口选择			例子:P00/P0_0										
#define		P_Switch2_Hi()						DEFINE_PB3_HI					//例子:DEFINE_P00_HI
#define		P_Switch2_Low()						DEFINE_PB3_LOW					//例子:DEFINE_P00_LOW
#define		P_Switch2_Output()					DEFINE_PB3_OUTPUT				//例子:DEFINE_P00_OUTPUT
#define		P_Switch2_Input()					DEFINE_PB3_INPUT				//例子:DEFINE_P00_INPUT
#define		P_Switch2_Enpull()					DEFINE_PB3_ENPULLUP				//例子:DEFINE_P00_ENPULL
#define		P_Switch2_Dispull()					DEFINE_PB3_DISPULLUP		    //例子:DEFINE_P00_DISPULL
//===================================================================================================//
//选择SWITCH3控制端口
//---------------------------------------------------------------------------------------------------//
