...
#define C_ADC_T2_CH 4
#define C_ADC_T3_CH 2
#define C_ADC_T4_CH 1
#define C_ADC_TP_CH 0
#elif defined	PCBMODEL_SR11_20240417
#define C_ADC_T1_CH 0
#define C_ADC_T2_CH 1
#define C_ADC_T3_CH 3
#define C_ADC_T4_CH 2
#define C_ADC_TP_CH 4
#endif

#if 0
//热敏电阻NTC AD温度对照表(室温)
const	U16  U16_adc_temproom_table[156]__attribute__((at(0x00007600))) =
{
...
const	U16  U16_adc_tempcoil_table[156]__attribute__((at(0x00007880))) =
{
	...
	C_AD_TEMPC_P106,	//106℃对应AD值
	C_AD_TEMPC_P107,	//107℃对应AD值
	C_AD_TEMPC_P108,	//108℃对应AD值
	C_AD_TEMPC_P109,	//109℃对应AD值
	C_AD_TEMPC_P110,	//110℃对应AD值
	C_AD_TEMPC_P111,	//111℃对应AD值
	C_AD_TEMPC_P112,	//112℃对应AD值
	C_AD_TEMPC_P113,	//113℃对应AD值
	C_AD_TEMPC_P114,	//114℃对应AD值
	C_AD_TEMPC_P115,	//115℃对应AD值
	C_AD_TEMPC_P116,	//116℃对应AD值
	C_AD_TEMPC_P117,	//117℃对应AD值
	C_AD_TEMPC_P118,	//118℃对应AD值
	C_AD_TEMPC_P119,	//119℃对应AD值
	C_AD_TEMPC_P120,	//120℃对应AD值
	C_AD_TEMPC_P121,	//121℃对应AD值
	C_AD_TEMPC_P122,	//122℃对应AD值
	C_AD_TEMPC_P123,	//123℃对应AD值
	C_AD_TEMPC_P124,	//124℃对应AD值
	C_AD_TEMPC_P125,	//125℃对应AD值	
};

//热敏电阻NTC AD温度对照表(排气)
const	U16  U16_adc_tempexhaust_table[156]__attribute__((at(0x00007B00))) =
{
...
U8	App_ADCGetTemperature(U8 channel, U8 u8_pstart)
{
	...
	U8   u8_range_max = u8_pstart + C_ADAPP_TABLEINDEX_HALF;			//确定查表最底边缘, 常量是表地址的一半
    U8   u8_pointer;													//查表指针
...
//	else if ((channel == 1) || (channel == 3))	//室温
//	{
