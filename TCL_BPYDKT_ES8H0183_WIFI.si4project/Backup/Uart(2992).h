...
//---------------------------------------------------------------------------------------------------//
#define    P_Uart3_Rx_Hi()                    DEFINE_PA27_HI
#define    P_Uart3_Rx_Low()                   DEFINE_PA27_LOW
#define    P_Uart3_Rx_Output()                DEFINE_PA27_OUTPUT
#define    P_Uart3_Rx_Input()                 DEFINE_PA27_INPUT
#define    P_Uart3_Rx_Enpull()                DEFINE_PA27_ENPULLUP
#define    P_Uart3_Rx_Dispull()               DEFINE_PA27_DISPULLUP
//---------------------------------------------------------------------------------------------------//
#define    P_Uart3_Tx_Hi()                    DEFINE_PA26_HI
#define    P_Uart3_Tx_Low()                   DEFINE_PA26_LOW
#define    P_Uart3_Tx_Output()                DEFINE_PA26_OUTPUT
#define    P_Uart3_Tx_Input()                 DEFINE_PA26_INPUT
#define    P_Uart3_Tx_Enpull()                DEFINE_PA26_ENPULLUP
#define    P_Uart3_Tx_Dispull()               DEFINE_PA26_DISPULLUP
//===================================================================================================//
//===================================================================================================//
//选择UART4控制端口
//---------------------------------------------------------------------------------------------------//
